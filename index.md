...
instructor: ["Marnee Dearman", "Amy Hudson", "Julian Pistorius", "Tyson Swetnam"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Niraj Altekar", "Michael Hernandez", "Uwe Hilgert", "Branden Lau", "Xiang Liu", "Cesar Medina", "Cristian Palacios", "Misty Ring-Ramirez", "Fernando Rios", "Travis Struck", "Frank Ventura", "James Waters"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p id="collaborative_notes"><b>
  We will use this <a href="https://pad.carpentries.org/2018-10-27-Tucson">collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code.
</b></p>
